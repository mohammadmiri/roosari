...
urlpatterns = [
    ...
    url(r'^siteadmin/ReserveForm/ReserveForm/add/$', RedirectView.as_view(url=urlsite+'admin/ReserveForm/reserveform/add/'), name='add_reserveform'),
    ...
    url(r'^siteadmin/ReserveForm/customer/add/$', RedirectView.as_view(url=urlsite+'admin/UserManager/customer/add'), name='add_customer'),
    url(r'^siteadmin/ReserveForm/AdminModel/$', RedirectView.as_view(url=urlsite+'admin/UserManager/adminsite'), name='changeList_admin'),
    ...
    url(r'^siteadmin/ReserveForm/karbarTehran/add/$', RedirectView.as_view(url=urlsite+'admin/UserManager/karbartehran/add/'), name='add_karbarTehran'),
    ...
    url(r'^siteadmin/ReserveForm/karbarKarkhane/add/$', RedirectView.as_view(url=urlsite+'admin/UserManager/karbarkarkhane/add/'), name='add_karbarKarkhane'),
    url(r'^siteadmin/ReserveForm/kargar/$', RedirectView.as_view(url=urlsite+'admin/UserManager/kargar'), name='changeList_kargar'),
    url(r'^siteadmin/ReserveForm/kargar/add/$', RedirectView.as_view(url=urlsite+'admin/UserManager/kargar/add/'), name='add_kargar'),
